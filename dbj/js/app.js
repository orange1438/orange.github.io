...
var Fire = cc.Layer.extend({
    ...
    init: function() {
        ...
        //this._tao.anchorY = 0.39;
        //this._tao.anchorX = 0.59;
        this._tao.anchorY = 0.40;
...
var GameOverLayer = cc.Layer.extend({
        ...
        initBg: function() {
            ...
            var b = "爹，就差那么一点点，流量 第一滴血，爹这顿斩获5豆币 爹正在大杀特杀，这顿斩获 爹已超神了，这顿斩获15豆".split(" ");
            var a="在召唤，别放弃，来继续！ ，累计50豆币可以换流量哦~ 10豆币，累计50豆币可以换流量哦~ 币，累计50豆币可以兑换流量哦~".split(" ");
      ...
      //      trace("num------------" + c + ":" + GD.SHARE);
            ...
            if(GD.SCORE<5000) {
                ...
                this._iconLabel = cc.LabelTTF.create("", "Arial", 40);
                this._iconLabel.color = cc.color.YELLOW;
                this._iconLabel.anchorX = 0.58;
                this.addChild(this._iconLabel);
                this._iconLabel.setString(a);

                a = cc.LabelTTF.create("", "Arial", 40);
            }
            else if(GD.SCORE<20000){
                b = b[2];
                a= a[2];
                ...
                this._commentLabel.setString(b);
                this._commentLabel.color = cc.color.YELLOW;
                this._iconLabel = cc.LabelTTF.create("", "Arial", 32);
                this._iconLabel.color = cc.color.YELLOW;
                this._iconLabel.anchorX = 0.55;
                this.addChild(this._iconLabel);
                this._iconLabel.setString(a);

                a = cc.LabelTTF.create("", "Arial", 20);
            }else if(GD.SCORE>=20000){
                b = b[3];
                a= a[3];
                ...
                this._commentLabel.setString(b);
                this._commentLabel.color = cc.color.YELLOW;
                this._iconLabel = cc.LabelTTF.create("", "Arial", 35);
                this._iconLabel.color = cc.color.YELLOW;
                this._iconLabel.anchorX = 0.55;
                this.addChild(this._iconLabel);
                this._iconLabel.setString(a);
