    ...
    _counterFunc: function (a) {
        ...
        if (!b.err) {
            ...
            if (a) {
                ...
                var k = Array.apply(null, arguments).slice(1), m = k.length;
...
cc._initSys = function (a, b) {
    ...
    c.isMobile = -1 != k.indexOf("mobile") ||
        -1 != k.indexOf("android");
    var m = g.language, m = (m = m ? m : g.browserLanguage) ? m.split("-")[0] : c.LANGUAGE_ENGLISH;
    c.language = m;
    var m = c.BROWSER_TYPE_UNKNOWN, n = k.match(/micromessenger|qqbrowser|mqqbrowser|ucbrowser|360browser|baiduboxapp|baidubrowser|maxthon|trident|opera|miuibrowser|firefox/i) || k.match(/chrome|safari/i);
...
(function () {
    ...
    cc.Class.extend = function (c) {
        ...
        for (var k = 0, m = arguments.length; k < m; ++k) {
            var n = arguments[k], q;
            for (q in n) {
                var s = "function" === typeof n[q], r = "function" === typeof e[q], u = a.test(n[q]);
...
cc._fontLoader = {
    ...
    _loadFont: function (a, b, c) {
        ...
        if (b instanceof Array)for (var k = 0, m = b.length; k < m; k++)c = e.extname(b[k]).toLowerCase(), h += "url('" + b[k] + "') format('" + f[c] + "')", h += k == m - 1 ? ";" : ","; else h += "url('" + b + "') format('" + f[c] + "');";
        g.textContent += h + "};";
        b = cc.newElement("div");
        c =
            b.style;
...
cc.EGLView = cc.Class.extend({
    ...
    _setViewPortMeta: function (a, b) {
        if (this._isAdjustViewPort) {
            var c = {
                ...
                "maximum-scale": "1.0",
                width: "device-width"
            }, d = document.getElementsByName("viewport"), e;
    ...
    setDesignResolutionSize: function (a, b, c) {
        if (isNaN(a) || 0 == a || isNaN(b) || 0 ==
            b)cc.log(cc._LogInfos.EGLView_setDesignResolutionSize); else {
    ...
    convertToLocationInView: function (a, b, c) {
        return {
            x: this._devicePixelRatio * (a - c.left), y: this._devicePixelRatio *
            (c.top + c.height - b)
        }
    },
...
(function () {
    var a = cc.ContainerStrategy.extend({
        ...
        apply: function (a, b) {
            var c = a._frameSize.width, d = a._frameSize.height, e = cc.container.style, n = b.width, q = b.height, s = c / n, r = d / q, u, t;
    ...
    var a = cc.ContentStrategy.extend({
        ...
        apply: function (a, b) {
            var c = cc._canvas.width, d = cc._canvas.height, e = b.width, n = b.height, q = c / e, s = d / n, r = 0, u, t;
            q < s ? (r = q, u = c, t = n * r) : (r = s, u = e * r, t = d);
            return this._buildResult(c, d, u, t, r, r)
        }
    }), c = cc.ContentStrategy.extend({
        apply: function (a, b) {
            var c = cc._canvas.width, d = cc._canvas.height, e = b.width, n = b.height, q = c / e, s = d / n, r, u, t;
...
cc.inputManager = {
    ...
    getHTMLElementPosition: function (a) {
        var b = document.documentElement, c = window, d = null, d = "function" === typeof a.getBoundingClientRect ? a.getBoundingClientRect() : a instanceof HTMLCanvasElement ? {
            left: 0,
            top: 0,
            width: a.width,
            height: a.height
    ...
    if (!(1 >= e)) {
        ...
        for (var f, g = e - 1, h = d; h < e; h++) {
            ...
            if (0 === h)m = cc.pPerp(cc.pNormalize(cc.pSub(k, cc.p(a[2 * (h + 1)], a[2 * (h + 1) + 1])))); else if (h === g)m = cc.pPerp(cc.pNormalize(cc.pSub(cc.p(a[2 * (h - 1)], a[2 * (h - 1) + 1]), k))); else {
                ...
                var n = cc.p(a[2 * (h + 1)], a[2 * (h + 1) + 1]), q = cc.pNormalize(cc.pSub(n, k)), s = cc.pNormalize(cc.pSub(m, k)), r = Math.acos(cc.pDot(q, s));
...
cc.Touch = cc.Class.extend({
    _point: null, _prevPoint: null, _id: 0, _startPointCaptured: !1, _startPoint: null, ctor: function (a, b, c) {
...
cc.Node = cc.Class.extend({
    ...
    addChild: function (a, b, c) {
        ...
        if (a === this)cc.log(cc._LogInfos.Node_addChild); else if (null !== a._parent)cc.log(cc._LogInfos.Node_addChild_2);
    ...
    getBoundingBoxToWorld: function () {
        var a = cc.rect(0, 0, this._contentSize.width, this._contentSize.height), b = this.nodeToWorldTransform(),
...
cc._renderType === cc._RENDER_TYPE_CANVAS ? (_p = cc.Node.prototype, _p.ctor = function () {
    ...
    if (this._transformDirty) {
        ...
        if (this._skewX || this._skewY) {
            var m = Math.tan(-this._skewX * Math.PI / 180), n = Math.tan(-this._skewY * Math.PI / 180);
...
cc.AtlasNode = cc.NodeRGBA.extend({
    ...
    _setColorForCanvas: function (a) {
        ...
        if (!(b.r == a.r && b.g == a.g && b.b == a.b)) {
            ...
            if (this.texture && (a = this._originalTexture.getHtmlElementObj()))if (b = cc.textureCache.getTextureColors(a))c = cc.rect(0, 0, a.width, a.height), a = cc.generateTintImage(a, b, this._realColor, c), b = new cc.Texture2D, b.initWithElement(a),
...
cc.LoaderScene = cc.Scene.extend({
    ...
    init: function () {
        ...
        cc._loaderImage && cc.loader.loadImg(cc._loaderImage, {isCrossOrigin: !1},
            function (b, c) {
                this.logoWidth = c.width;
                this.logoHeight = c.height;
                a._initStage(c, cc.visibleRect.center)
            });
        cc._loadingbar && (cc.loader.loadImg(cc._loadingbar, {isCrossOrigin: !1}, function (b, c) {
...
cc.Layer = cc.Node.extend({
    _isBaked: !1, _bakeSprite: null, _className: "Layer", ctor: function () {
        var a = cc.Node.prototype;
        a.ctor.call(this);
        this._ignoreAnchorPointForPosition = !0;
        ...
        if (this._visible) {
            ...
            if (this._cacheDirty) {
                ...
                if (this._ignoreAnchorPointForPosition)f.translate(0 -
                    ...
                    var k = this.getAnchorPointInPoints(), m = h.x - k.x, h = h.y - k.y;
        ...
        for (c in a) {
            ...
            if (g) {
                for (var h = [], k = 0; k < g.length; k++) {
                    var m = g[k], n = m.spriteframe, q = b.getSpriteFrame(n);
                    if (q) {
...
cc.LabelTTF = cc.Sprite.extend({
    ...
    _checkNextline: function (a, b) {
        ...
        if (c)return e;
        q = a.substr(0, d);
        for (e = d; h = m.exec(q);)if (e = h[1].length, q = h[1], f = this._measure(q), f < b) {
            n.test(h[2]) && e++;
            break
        }
        return e || 1
...
cc.RenderTexture = cc.Node.extend({
    ...
    _initWithWidthAndHeightForWebGL: function (a, b, c, d) {
        ...
        var e = cc._renderContext, f = cc.contentScaleFactor();
        a = 0 | a * f;
        b = 0 | b * f;
    ...
    _beginForWebGL: function () {
        ...
        var b = this._texture.getContentSizeInPixels(), c = cc.director.getWinSizeInPixels(), a = c.width / b.width, c = c.height / b.height, d = cc._renderContext;
    ...
    _beginWithClearForWebGL: function (a, b, c, d, e, f, g) {
        this.begin();
        var h = cc._renderContext, k = [0, 0, 0, 0], m = 0, n = 0;
    ...
    _endForWebGL: function () {
        var a = cc._renderContext, b = cc.director;
    ...
    _clearDepthForWebGL: function (a) {
        this.begin();
        var b = cc._renderContext, c = b.getParameter(b.DEPTH_CLEAR_VALUE);
        b.clearDepth(a);
    ...
    _clearStencilForWebGL: function (a) {
        var b = cc._renderContext, c = b.getParameter(b.STENCIL_CLEAR_VALUE);
        b.clearStencil(a);
...
cc.LabelAtlas = cc.AtlasNode.extend({
    ...
    _updateAtlasValuesForCanvas: function () {
        for (var a = this._string, b = a.length, c = this.texture, d = this._itemWidth, e = this._itemHeight, f = 0; f < b; f++) {
            var g = a.charCodeAt(f) - this._mapStartChar.charCodeAt(0), h = parseInt(g % this._itemsPerRow, 10), g = parseInt(g /
                this._itemsPerRow, 10), h = cc.rect(h * d, g * e, d, e), g = a.charCodeAt(f), k = this.getChildByTag(f);
    ...
    _updateAtlasValuesForWebGL: function () {
        var a = this._string, b = a.length, c = this.textureAtlas,
            d = c.texture, e = d.pixelsWidth, d = d.pixelsHeight, f = this._itemWidth, g = this._itemHeight;
        ...
        for (var h = c.quads, k = this._displayedColor, k = {
            ...
            var q = a.charCodeAt(n) - this._mapStartChar.charCodeAt(0), s = q % this._itemsPerRow, r = 0 | q / this._itemsPerRow,
                u;
            ...
            var t = h[n], v = t.tl, w = t.tr, x = t.bl, t = t.br;
            v.texCoords.u = s;
            v.texCoords.v = r;
            w.texCoords.u = q;
            w.texCoords.v = r;
...
cc.DrawNodeCanvas = cc.Node.extend({
    _buffer: null, _blendFunc: null, _lineWidth: 1, _drawColor: null, _className: "DrawNodeCanvas", ctor: function () {
        ...
        for (var h = 2 * Math.PI / d, k = [], m = 0; m <= d; m++) {
            var n = m * h, q = b * Math.cos(n + c) + a.x, n = b * Math.sin(n + c) + a.y;
            k.push(cc.p(q, n))
        }
        ...
        for (var h =
            [], k = 0, m = 0; m < e; m++) {
            var n = Math.pow(1 - k, 3) * a.x + 3 * Math.pow(1 - k, 2) * k * b.x + 3 * (1 - k) * k * k * c.x + k * k * k * d.x, q = Math.pow(1 - k, 3) * a.y + 3 * Math.pow(1 - k, 2) * k * b.y + 3 * (1 - k) * k * k * c.y + k * k * k * d.y;
            h.push(cc.p(n, q));
            k += 1 / e
        }
        h.push(cc.p(d.x, d.y));
        ...
        var c = b.fillColor, d = b.verts[0], e = b.lineWidth, f = cc.view.getScaleX(), g = cc.view.getScaleY();
    ...
    _drawSegment: function (a, b) {
        var c = b.lineColor, d = b.verts[0], e = b.verts[1], f = b.lineWidth, g = b.lineCap, h = cc.view.getScaleX(), k = cc.view.getScaleY();
        ...
        if (null != c) {
            var n = c[0], q = cc.view.getScaleX(), s = cc.view.getScaleY();
            a.lineCap = d;
...
cc.DrawNodeWebGL = cc.Node.extend({
    ...
    drawCubicBezier: function (a, b, c, d, e, f, g) {
        ...
        for (var h = [], k = 0, m = 0; m < e; m++) {
            var n =
                Math.pow(1 - k, 3) * a.x + 3 * Math.pow(1 - k, 2) * k * b.x + 3 * (1 - k) * k * k * c.x + k * k * k * d.x, q = Math.pow(1 - k, 3) * a.y + 3 * Math.pow(1 - k, 2) * k * b.y + 3 * (1 - k) * k * k * c.y + k * k * k * d.y;
            h.push(cc.p(n, q));
            k += 1 / e
        }
        h.push(cc.p(d.x, d.y));
    ...
    _ensureCapacity: function (a) {
        ...
        if (b.length + a > this._bufferCapacity) {
            ...
            if (null == b || 0 === b.length)this._buffer = [], this._trianglesArrayBuffer = new ArrayBuffer(c *
                this._bufferCapacity), this._trianglesReader = new Uint8Array(this._trianglesArrayBuffer); else {
                a = [];
    ...
    drawSegment: function (a, b, c, d) {
        ...
        var k = cc.v2fadd(f, cc.v2fsub(g, h)), m = cc.v2fsub(f, g), f = cc.v2fadd(f, g), n = cc.v2fsub(e, g), q = cc.v2fadd(e, g), s = cc.v2fsub(e, cc.v2fsub(g, h)), e = cc.v2fadd(e, cc.v2fadd(g, h)), g = cc.V2F_C4B_T2F_Triangle.BYTES_PER_ELEMENT, h = this._trianglesArrayBuffer, r = this._buffer;
        ...
        r.push(new cc.V2F_C4B_T2F_Triangle({vertices: f, colors: d, texCoords: cc.__t(b)}, {
            vertices: n,
            colors: d, texCoords: cc.__t(cc.v2fneg(b))
    ...
    drawPoly: function (a, b, c, d) {
        if (null == b)this._drawSegments(a, c, d, !0); else {
            ...
            this._ensureCapacity(3 *
                (3 * m - 2));
            var q = cc.V2F_C4B_T2F_Triangle.BYTES_PER_ELEMENT, s = this._trianglesArrayBuffer, r = this._buffer, u = !1 == n ? 0.5 : 0;
    ...
    _drawSegments: function (a, b, c, d) {
        ...
        if (!(0 >= b)) {
            ...
            var n = this._trianglesArrayBuffer, q = this._buffer;
            d = d ? m : m - 1;
            for (f = 0; f < d; f++) {
                var s = (f + 1) % m;
                g = cc.__v2f(a[f]);
                ...
                q.push(new cc.V2F_C4B_T2F_Triangle({vertices: s, colors: c, texCoords: cc.__t(cc.v2fneg(r))}, {
                    vertices: v,
                    colors: c, texCoords: cc.__t(cc.v2fneg(r))
...
cc.RotateBy = cc.ActionInterval.extend({
    _angleX: 0, _startAngleX: 0, _angleY: 0, _startAngleY: 0, ctor: function (a, b, c) {
        cc.ActionInterval.prototype.ctor.call(this);
        void 0 !== b && this.initWithDuration(a, b, c)
    }, initWithDuration: function (a, b, c) {
...
cc.MoveBy = cc.ActionInterval.extend({
    _positionDelta: null, _startPosition: null, _previousPosition: null, ctor: function (a, b, c) {
        cc.ActionInterval.prototype.ctor.call(this);
        ...
        if (this.target) {
            ...
            if (cc.ENABLE_STACKABLE_ACTIONS) {
                var d =
                    this.target.getPositionX(), e = this.target.getPositionY(), f = this._previousPosition;
                c.x = c.x + d - f.x;
                c.y = c.y + e - f.y;
                b += c.x;
                a += c.y;
...
cc.JumpBy = cc.ActionInterval.extend({
    _startPosition: null, _delta: null, _height: 0, _jumps: 0, _previousPosition: null, ctor: function (a, b, c, d, e) {
        cc.ActionInterval.prototype.ctor.call(this);
        this._startPosition = cc.p(0, 0);
        this._previousPosition = cc.p(0, 0);
...
cc.BezierBy = cc.ActionInterval.extend({
    _config: null, _startPosition: null, _previousPosition: null, ctor: function (a, b) {
        ...
        var a = this._config, a = [cc.pAdd(a[1], cc.pNeg(a[2])), cc.pAdd(a[0], cc.pNeg(a[2])), cc.pNeg(a[2])], a = cc.BezierBy.create(this._duration, a);
        this._cloneDecoration(a);
        this._reverseEaseList(a);
        return a
    }
...
cc.FadeIn = cc.FadeTo.extend({
    _reverseAction: null, reverse: function () {
...
cc.TintBy = cc.ActionInterval.extend({
    _deltaR: 0, _deltaG: 0, _deltaB: 0, _fromR: 0, _fromG: 0, _fromB: 0, ctor: function (a, b, c, d) {
        cc.ActionInterval.prototype.ctor.call(this);
        void 0 !== d && this.initWithDuration(a, b, c, d)
    }, initWithDuration: function (a, b, c, d) {
...
cc.Animate = cc.ActionInterval.extend({
    _animation: null, _nextFrame: 0, _origFrame: null, _executedLoops: 0, _splitTimes: null, ctor: function (a) {
        ...
        for (var b = this._animation.getFrames(), c = b.length, d = this._splitTimes, e = this._nextFrame; e < c; e++)if (d[e] <= a)this.target.setSpriteFrame(b[e].getSpriteFrame()), this._nextFrame = e + 1; else break
    }, reverse: function () {
...
cc.CallFunc = cc.ActionInstant.extend({
    _selectorTarget: null, _callFunc: null, _function: null, _data: null, ctor: function (a, b, c) {
        cc.FiniteTimeAction.prototype.ctor.call(this);
...
cc.ProgressTimer = cc.NodeRGBA.extend({
    ...
    _textureCoordFromAlphaPoint: function (a) {
        var b = this._sprite;
        if (!b)return {u: 0, v: 0};
        var c = b.quad, d = cc.p(c.bl.texCoords.u, c.bl.texCoords.v), c = cc.p(c.tr.texCoords.u, c.tr.texCoords.v);
    ...
    _vertexFromAlphaPoint: function (a) {
        ...
        var b = this._sprite.quad, c = cc.p(b.bl.vertices.x, b.bl.vertices.y), b = cc.p(b.tr.vertices.x, b.tr.vertices.y);
    ...
    _drawForCanvas: function (a) {
        ...
        var c = cc.view.getScaleX(), d = cc.view.getScaleY();
    ...
    _updateRadial: function () {
        if (this._sprite) {
            ...
            if (0 == a)e = d, c = 0; else if (1 == a)e = d, c = 4; else {
                var f = cc.FLT_MAX, g = cc.ProgressTimer.TEXTURE_COORDS_COUNT;
                for (a = 0; a <= g; ++a) {
    ...
    _updateProgressForCanvas: function () {
        ...
        if (this._type == cc.ProgressTimer.TYPE_RADIAL) {
            ...
            var g = cc.size((b - e.width) * g, (c - e.height) * g), g = cc.size(e.width + g.width, e.height + g.height), h = cc.p(b * d.x, c * d.y);
            e = h.x - g.width / 2;
...
cc.ProgressFromTo = cc.ActionInterval.extend({
    _to: 0, _from: 0, ctor: function (a, b, c) {
        cc.ActionInterval.prototype.ctor.call(this);
        this._from = this._to = 0;
        void 0 !== c && this.initWithDuration(a, b, c)
    }, initWithDuration: function (a, b, c) {
...
cc.TransitionSceneOriented = cc.TransitionScene.extend({
    _orientation: 0, initWithDuration: function (a, b, c) {
...
cc.TransitionCrossFade = cc.TransitionScene.extend({
    onEnter: function () {
        cc.TransitionScene.prototype.onEnter.call(this);
        var a = cc.color(0, 0, 0, 0), b = cc.director.getWinSize(), a = cc.LayerColor.create(a), c = cc.RenderTexture.create(b.width, b.height);
        if (null != c) {
...
cc.TransitionTurnOffTiles = cc.TransitionScene.extend({
    _sceneOrder: function () {
        ...
        cc.TransitionScene.prototype.onEnter.call(this);
        var a = cc.director.getWinSize(), a = cc.TurnOffTiles.create(this._duration, cc.size(0 | 12 * (a.width / a.height), 12)), a = this.easeActionWithAction(a);
...
cc.TransitionFadeTR = cc.TransitionScene.extend({
    _sceneOrder: function () {
        ...
        cc.TransitionScene.prototype.onEnter.call(this);
        var a = cc.director.getWinSize(), a = this.actionWithSize(cc.size(0 | 12 * (a.width / a.height), 12));
...
cc.TransitionProgress = cc.TransitionScene.extend({
    _to: 0, _from: 0, _sceneToBeModified: null, _className: "TransitionProgress", _setAttrs: function (a, b, c) {
        a.attr({x: b, y: c, anchorX: 0.5, anchorY: 0.5})
    }, onEnter: function () {
        cc.TransitionScene.prototype.onEnter.call(this);
        this._setupTransition();
        var a = cc.director.getWinSize(), b = cc.RenderTexture.create(a.width, a.height);
...
cc.TransitionPageTurn = cc.TransitionScene.extend({
    _back: !0, _className: "TransitionPageTurn", initWithDuration: function (a, b, c) {
        this._back = c;
